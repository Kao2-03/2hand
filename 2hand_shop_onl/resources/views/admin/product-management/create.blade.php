        ...
        <form action="{{ route('admin.products.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="add-product__block1">
                ...
                <div class="add-product__block1--line3">
                    ...
                    <input class="product-input" type="text" name="product_name"
                        placeholder="This is the name of product">
                </div>
                <div class="add-product__block1--line3">
                    <div class="product-name">Price</div>
                    <input class="product-input" type="text" name="product_price"
                        placeholder="This is the price of product">
                </div>
                <div class="add-product__block1--line4">
                    <div class="product-desc">Description</div>
                    <textarea class="product-texta" name="product_desc" cols="30" rows="10"></textarea>
                </div>
                ...
                <div class="add-product__block1--line5">
                    ...
                    <input class="add-product-input" name="product_brand" placeholder="This is the Brand of product">
                </div>
                <div class="add-product__block1--line5">
                    <div class="product-brand">Origin</div>
                    <input class="add-product-input" name="product_origin" placeholder="This is the Origin of product">
                </div>
                <div class="add-product__block1--line5">
                    <div class="product-brand">For Gender</div>
                    <input class="add-product-input" name="product_for" placeholder="This is the Origin of product">
                </div>
            </div>
