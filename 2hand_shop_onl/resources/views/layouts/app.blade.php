        ...
        <div class="container">
            <div class="header-row">
                ...
                <div class="header-search">
                    <input type="text" name="search" placeholder="Search for anything" class="header__input">
                            ...
                            <div>
                                ...
                                @else
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="btn btn-sign btn-sign-up">Register</a>
                                    @endif
                                    <a href="{{ route('login') }}" class="btn btn-sign btn-sign-in">Login</a>
                                @endauth
                            </div>
                        @endif
                    @else
                        ...
                        <div id="dropdown" class="header-user__dropdown hide">
                            <div class="header-user__dropdown-wrap">
                                <a class="user__link" href="{{ route('user.info') }}">Account</a>
            ...
            <navbar class="nav">
                ...
                <div class="nav-wrap">
                    <a href="{{ route('admin.products.index') }}" class="nav__link">Admin</a>
                </div>
            </navbar>
        </div>
    </header>
...
{{-- <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelector('.header-search__icon').addEventListener('click', function () {
            submitSearchForm();
        });
