...
@section('content')
    <div id="add-address" class="modal show add-address">
        <div class="modal__content">
            <form action="{{ route('user.address.update', $address->address_id) }}" method="POST" class="form"
                ...
                <div class="modal__body">
                    <div class="form__row">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $address->name }}" class="form__input"
                                placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label for="phone" class="form__label">Phone</label>
                            <input type="tel" name="phone" value="{{ $address->phone }}" class="form__input"
                                placeholder="Phone">
                        </div>
                    </div>
                    <div class="form__row">
                    ...
                    <div class="form__row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address_detail" value="{{ $address->address_detail }}"
                                class="form__input" placeholder="Address Detail">
                        </div>
                    </div>
                </div>
                <div class="modal__bottom">
                    <button type="submit" class="btn modal__btn">Update</button>
                </div>
            </form>
        </div>
    </div>
